...
/*     */ 
/*     */ 
/*     */ public class _2228AThornInItsSide
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 2228;
/*     */   
/*     */   public _2228AThornInItsSide() {
/*  43 */     super(Integer.valueOf(2228));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  49 */     this.qe.setNpcQuestData(203619).addOnTalkEvent(2228);
/*  50 */     this.qe.setQuestItemIds(182203221).add(2228);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  57 */     QuestState qs = player.getQuestStateList().getQuestState(2228);
/*     */     
/*  59 */     int targetId = 0;
...
/*     */           
/*  81 */           ItemService.removeItemFromInventoryByItemId(player, 182203221);
/*  82 */           qs.setQuestVar(1);
...
/* 104 */     ThreadPoolManager.getInstance().schedule(new Runnable()
/*     */         {
/*     */           public void run()
/*     */           {
/* 108 */             PacketSendUtility.broadcastPacket(player, (AionServerPacket)new SM_ITEM_USAGE_ANIMATION(player.getObjectId(), itemObjId, id, 0, 1, 0), true);
/* 109 */             _2228AThornInItsSide.this.sendQuestDialog(player, 0, 4);
/*     */           }
/*     */         }3000L);
/* 112 */     return true;
/*     */   }
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\altgard\_2228AThornInItsSide.class
