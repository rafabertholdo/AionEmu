...
public class _2207ConversingWithaSkurv extends QuestHandler {
  ...
  public _2207ConversingWithaSkurv() {
    super(Integer.valueOf(2207));
  }

  public void register() {
    this.qe.setNpcQuestData(203590).addOnQuestStart(2207);
    this.qe.setNpcQuestData(203590).addOnTalkEvent(2207);
    this.qe.setNpcQuestData(203591).addOnTalkEvent(2207);
    this.qe.setNpcQuestData(203557).addOnTalkEvent(2207);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(2207);
    if (targetId == 203590) {
