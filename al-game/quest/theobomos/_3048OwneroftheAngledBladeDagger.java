...
public class _3048OwneroftheAngledBladeDagger extends QuestHandler {
  ...
  public _3048OwneroftheAngledBladeDagger() {
    super(Integer.valueOf(3048));
  }

  public void register() {
    this.qe.setNpcQuestData(798208).addOnTalkEvent(3048);
    this.qe.setNpcQuestData(798206).addOnTalkEvent(3048);
    this.qe.setQuestItemIds(182208033).add(3048);
  }

  public boolean onDialogEvent(QuestEnv env) {
    Player player = env.getPlayer();
    QuestState qs = player.getQuestStateList().getQuestState(3048);
    ...
    if (targetId == 0) {
      ...
      if (qs != null) {
        ...
        if (env.getDialogId().intValue() == 1009) {
          ...
          ItemService.removeItemFromInventoryByItemId(player, 182208033);
          qs.setQuestVar(1);
    ...
    ThreadPoolManager.getInstance().schedule(new Runnable()
        {
          public void run()
          {
            ...
            _3048OwneroftheAngledBladeDagger.this.sendQuestDialog(player, 0, 4);
          }
        }3000L);
    return true;
  }
