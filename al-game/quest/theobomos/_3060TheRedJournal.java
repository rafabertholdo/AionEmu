...
public class _3060TheRedJournal extends QuestHandler {
  ...
  public _3060TheRedJournal() {
    super(Integer.valueOf(3060));
  }

  public void register() {
    this.qe.setNpcQuestData(798190).addOnTalkEvent(3060);
    this.qe.setNpcQuestData(798191).addOnTalkEvent(3060);
    this.qe.setNpcQuestData(798192).addOnTalkEvent(3060);
    this.qe.setNpcQuestData(798193).addOnTalkEvent(3060);
    this.qe.setQuestItemIds(182208043).add(3060);
  }

  public boolean onDialogEvent(QuestEnv env) {
    Player player = env.getPlayer();
    QuestState qs = player.getQuestStateList().getQuestState(3060);
    ...
    if (targetId == 0) {
      ...
      if (qs != null) {
        ...
        if (env.getDialogId().intValue() == 1009) {
          ...
          ItemService.removeItemFromInventoryByItemId(player, 182208043);
          qs.setQuestVar(1);
    ...
    ThreadPoolManager.getInstance().schedule(new Runnable()
        {
          public void run()
          {
            ...
            _3060TheRedJournal.this.sendQuestDialog(player, 0, 4);
          }
        }3000L);
    return true;
  }
