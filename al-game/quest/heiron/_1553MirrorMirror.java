  ...
  extends QuestHandler
{
  ...
  public _1553MirrorMirror() {
    super(Integer.valueOf(1553));
  }


  
  public void register() {
    this.qe.setNpcQuestData(203786).addOnQuestStart(1553);
    this.qe.setNpcQuestData(203786).addOnTalkEvent(1553);
    this.qe.setNpcQuestData(730051).addOnTalkEvent(1553);
    this.qe.setNpcQuestData(204500).addOnTalkEvent(1553);
    this.qe.setNpcQuestData(204584).addOnTalkEvent(1553);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(1553);
    if (targetId == 203786) {
