  ...
  extends QuestHandler
{
  ...
  public _1620StartSpreadingTheNews() {
    super(Integer.valueOf(1620));
  }


  
  public void register() {
    this.qe.setNpcQuestData(204519).addOnQuestStart(1620);
    this.qe.setNpcQuestData(204519).addOnTalkEvent(1620);
    this.qe.setNpcQuestData(790000).addOnTalkEvent(1620);
    this.qe.setNpcQuestData(730001).addOnTalkEvent(1620);
    this.qe.setNpcQuestData(203125).addOnTalkEvent(1620);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(1620);
    if (targetId == 204519) {
