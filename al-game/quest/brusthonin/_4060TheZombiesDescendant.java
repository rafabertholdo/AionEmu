...
public class _4060TheZombiesDescendant extends QuestHandler {
  ...
  public void register() {
    ...
    this.qe.setNpcQuestData(204731).addOnTalkEvent(4060);
    this.qe.setNpcQuestData(205204).addOnTalkEvent(4060);
    ...
    ThreadPoolManager.getInstance().schedule(new Runnable()
        {
          public void run()
          {
            ...
            _4060TheZombiesDescendant.this.sendQuestDialog(player, 0, 4);
          }
        }3000L);
    return true;
  }
