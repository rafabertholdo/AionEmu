...
/*     */ 
/*     */ 
/*     */ public class _2611ConsultingtheLeaders
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 2611;
/*     */   
/*     */   public _2611ConsultingtheLeaders() {
/*  21 */     super(Integer.valueOf(2611));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  27 */     this.qe.setNpcQuestData(204763).addOnQuestStart(2611);
/*  28 */     this.qe.setNpcQuestData(204763).addOnTalkEvent(2611);
/*  29 */     this.qe.setNpcQuestData(204773).addOnTalkEvent(2611);
/*  30 */     this.qe.setNpcQuestData(204772).addOnTalkEvent(2611);
/*  31 */     this.qe.setNpcQuestData(204700).addOnTalkEvent(2611);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  41 */     QuestState qs = player.getQuestStateList().getQuestState(2611);
/*  42 */     if (targetId == 204763) {
/*     */       
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\beluslan\_2611ConsultingtheLeaders.class
