...
/*     */ 
/*     */ 
/*     */ public class _2539TrystoftheShadow
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 2539;
/*     */   
/*     */   public _2539TrystoftheShadow() {
/*  21 */     super(Integer.valueOf(2539));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  27 */     this.qe.setNpcQuestData(790022).addOnQuestStart(2539);
/*  28 */     this.qe.setNpcQuestData(790022).addOnTalkEvent(2539);
/*  29 */     this.qe.setNpcQuestData(204433).addOnTalkEvent(2539);
/*  30 */     this.qe.setNpcQuestData(204112).addOnTalkEvent(2539);
/*  31 */     this.qe.setNpcQuestData(204056).addOnTalkEvent(2539);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  41 */     QuestState qs = player.getQuestStateList().getQuestState(2539);
/*  42 */     if (targetId == 790022) {
/*     */       
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\beluslan\_2539TrystoftheShadow.class
