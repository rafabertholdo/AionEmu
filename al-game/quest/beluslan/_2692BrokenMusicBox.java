...
/*     */ 
/*     */ 
/*     */ public class _2692BrokenMusicBox
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 2692;
/*     */   
/*     */   public _2692BrokenMusicBox() {
/*  21 */     super(Integer.valueOf(2692));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  27 */     this.qe.setNpcQuestData(212164).addOnQuestStart(2692);
/*  28 */     this.qe.setNpcQuestData(212164).addOnTalkEvent(2692);
/*  29 */     this.qe.setNpcQuestData(204108).addOnTalkEvent(2692);
/*  30 */     this.qe.setNpcQuestData(279027).addOnTalkEvent(2692);
/*  31 */     this.qe.setNpcQuestData(279029).addOnTalkEvent(2692);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  41 */     QuestState qs = player.getQuestStateList().getQuestState(2692);
/*  42 */     if (targetId == 212164) {
/*     */       
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\beluslan\_2692BrokenMusicBox.class
