...
/*  40 */     super(Integer.valueOf(1916));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  46 */     this.qe.addQuestLvlUp(1916);
/*  47 */     this.qe.setNpcQuestData(203726).addOnTalkEvent(1916);
/*  48 */     this.qe.setNpcQuestData(203097).addOnTalkEvent(1916);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  55 */     QuestState qs = player.getQuestStateList().getQuestState(1916);
/*  56 */     if (qs == null) {
/*  57 */       return false;
/*     */     }
...
/* 113 */     QuestState qs = player.getQuestStateList().getQuestState(1916);
/* 114 */     boolean lvlCheck = QuestService.checkLevelRequirement(1916, player.getCommonData().getLevel());
/* 115 */     if (qs != null || !lvlCheck) {
/* 116 */       return false;
/*     */     }
/* 118 */     env.setQuestId(Integer.valueOf(1916));
