...
/*     */ 
/*     */ 
/*     */ public class _2902DispatchtoAltgard
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 2902;
/*     */   
/*     */   public _2902DispatchtoAltgard() {
/*  40 */     super(Integer.valueOf(2902));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  46 */     this.qe.addQuestLvlUp(2902);
/*  47 */     this.qe.setNpcQuestData(204191).addOnTalkEvent(2902);
/*  48 */     this.qe.setNpcQuestData(203559).addOnTalkEvent(2902);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  55 */     QuestState qs = player.getQuestStateList().getQuestState(2902);
/*  56 */     if (qs == null) {
/*  57 */       return false;
/*     */     }
...
/* 113 */     QuestState qs = player.getQuestStateList().getQuestState(2902);
/* 114 */     boolean lvlCheck = QuestService.checkLevelRequirement(2902, player.getCommonData().getLevel());
/* 115 */     if (qs != null || !lvlCheck) {
/* 116 */       return false;
/*     */     }
/* 118 */     env.setQuestId(Integer.valueOf(2902));
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\ascension\_2902DispatchtoAltgard.class
