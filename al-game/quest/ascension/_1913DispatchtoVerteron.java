...
/*     */ 
/*     */ 
/*     */ public class _1913DispatchtoVerteron
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 1913;
/*     */   
/*     */   public _1913DispatchtoVerteron() {
/*  40 */     super(Integer.valueOf(1913));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  46 */     this.qe.addQuestLvlUp(1913);
/*  47 */     this.qe.setNpcQuestData(203726).addOnTalkEvent(1913);
/*  48 */     this.qe.setNpcQuestData(203097).addOnTalkEvent(1913);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  55 */     QuestState qs = player.getQuestStateList().getQuestState(1913);
/*  56 */     if (qs == null) {
/*  57 */       return false;
/*     */     }
...
/* 113 */     QuestState qs = player.getQuestStateList().getQuestState(1913);
/* 114 */     boolean lvlCheck = QuestService.checkLevelRequirement(1913, player.getCommonData().getLevel());
/* 115 */     if (qs != null || !lvlCheck) {
/* 116 */       return false;
/*     */     }
/* 118 */     env.setQuestId(Integer.valueOf(1913));
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\ascension\_1913DispatchtoVerteron.class
