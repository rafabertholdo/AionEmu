...
/*     */ 
/*     */ 
/*     */ public class _1914DispatchtoVerteron
/*     */   extends QuestHandler
/*     */ {
/*     */   private static final int questId = 1914;
/*     */   
/*     */   public _1914DispatchtoVerteron() {
/*  40 */     super(Integer.valueOf(1914));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void register() {
/*  46 */     this.qe.addQuestLvlUp(1914);
/*  47 */     this.qe.setNpcQuestData(203726).addOnTalkEvent(1914);
/*  48 */     this.qe.setNpcQuestData(203097).addOnTalkEvent(1914);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  55 */     QuestState qs = player.getQuestStateList().getQuestState(1914);
/*  56 */     if (qs == null) {
/*  57 */       return false;
/*     */     }
...
/* 113 */     QuestState qs = player.getQuestStateList().getQuestState(1914);
/* 114 */     boolean lvlCheck = QuestService.checkLevelRequirement(1914, player.getCommonData().getLevel());
/* 115 */     if (qs != null || !lvlCheck) {
/* 116 */       return false;
/*     */     }
/* 118 */     env.setQuestId(Integer.valueOf(1914));
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\quest\ascension\_1914DispatchtoVerteron.class
