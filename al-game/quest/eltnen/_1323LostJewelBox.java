...
public class _1323LostJewelBox extends QuestHandler {
  ...
  public _1323LostJewelBox() {
    super(Integer.valueOf(1323));
  }

  public void register() {
    this.qe.setNpcQuestData(730019).addOnTalkEvent(1323);
    this.qe.setNpcQuestData(203939).addOnTalkEvent(1323);
    this.qe.setQuestItemIds(182201309).add(1323);
  }

  public boolean onDialogEvent(QuestEnv env) {
    Player player = env.getPlayer();
    QuestState qs = player.getQuestStateList().getQuestState(1323);
    ...
    if (targetId == 0) {
      ...
      if (qs != null) {
        ...
        if (env.getDialogId().intValue() == 1009) {
          ...
          ItemService.removeItemFromInventoryByItemId(player, 182201309);
          qs.setQuestVar(1);
    ...
    ThreadPoolManager.getInstance().schedule(new Runnable()
        {
          public void run()
          {
            ...
            _1323LostJewelBox.this.sendQuestDialog(player, 0, 4);
          }
        }3000L);
    return true;
  }
