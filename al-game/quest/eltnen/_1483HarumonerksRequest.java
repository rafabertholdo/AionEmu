  ...
  extends QuestHandler
{
  ...
  public _1483HarumonerksRequest() {
    super(Integer.valueOf(1483));
  }


  
  public void register() {
    this.qe.setNpcQuestData(798126).addOnQuestStart(1483);
    this.qe.setNpcQuestData(798126).addOnTalkEvent(1483);
    this.qe.setNpcQuestData(203940).addOnTalkEvent(1483);
    this.qe.setNpcQuestData(203944).addOnTalkEvent(1483);
    this.qe.setNpcQuestData(798127).addOnTalkEvent(1483);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(1483);
    if (targetId == 798126) {
