  ...
  extends QuestHandler
{
  ...
  public _1385RescuingGriffo() {
    super(Integer.valueOf(1385));
  }


  
  public void register() {
    this.qe.setNpcQuestData(212057).addOnQuestStart(1385);
    this.qe.setNpcQuestData(212057).addOnTalkEvent(1385);
    this.qe.setNpcQuestData(204029).addOnTalkEvent(1385);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(1385);
    if (targetId == 212057) {
