  ...
  extends QuestHandler
{
  ...
  public _1452DoubtfulCharacters() {
    super(Integer.valueOf(1452));
  }


  
  public void register() {
    this.qe.setNpcQuestData(203934).addOnQuestStart(1452);
    this.qe.setNpcQuestData(203934).addOnTalkEvent(1452);
    this.qe.setNpcQuestData(203834).addOnTalkEvent(1452);
    this.qe.setNpcQuestData(203704).addOnTalkEvent(1452);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(1452);
    if (targetId == 203934) {
