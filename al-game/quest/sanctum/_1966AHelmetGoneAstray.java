...
/* 27 */     super(Integer.valueOf(1966));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public void register() {
/* 33 */     this.qe.setNpcQuestData(278555).addOnTalkEvent(1966);
/* 34 */     this.qe.setQuestItemIds(182206035).add(1966);
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 41 */     QuestState qs = player.getQuestStateList().getQuestState(1966);
/*    */     
/* 43 */     int targetId = 0;
...
/*    */           
/* 65 */           ItemService.removeItemFromInventoryByItemId(player, 182206035);
/* 66 */           qs.setQuestVar(1);
...
/*    */             
/* 95 */             _1966AHelmetGoneAstray.this.sendQuestDialog(player, 0, 4);
/*    */           }
/*    */         }3000L);
/* 98 */     return true;
/*    */   }
