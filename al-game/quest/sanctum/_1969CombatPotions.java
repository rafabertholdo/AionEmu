  ...
  extends QuestHandler
{
  ...
  public _1969CombatPotions() {
    super(Integer.valueOf(1969));
  }


  
  public void register() {
    this.qe.setNpcQuestData(278556).addOnTalkEvent(1969);
    this.qe.setQuestItemIds(182206038).add(1969);
  }
  ...
  public boolean onDialogEvent(QuestEnv env) {
    ...
    QuestState qs = player.getQuestStateList().getQuestState(1969);
    ...
    if (targetId == 0) {
      ...
      if (qs != null) {
        ...
        if (env.getDialogId().intValue() == 1009) {
          ...
          ItemService.removeItemFromInventoryByItemId(player, 182206038);
          qs.setQuestVar(1);
    ...
    ThreadPoolManager.getInstance().schedule(new Runnable()
        {
          public void run()
          {
            ...
            _1969CombatPotions.this.sendQuestDialog(player, 0, 4);
          }
        }3000L);
    return true;
  }
