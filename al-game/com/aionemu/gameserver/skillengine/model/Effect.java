...
public class Effect
{
  ...
  public void initialize() {
    ...
    for (EffectTemplate template : getEffectTemplates()) {
      ...
      if (template instanceof com.aionemu.gameserver.skillengine.effect.DamageEffect && !(template instanceof com.aionemu.gameserver.skillengine.effect.DamageOverTimeEffect))
      {
        isDmgEffect = true;
      }
    } 
  ...
  private void activateToggleSkill() {
    PacketSendUtility.sendPacket((Player)this.effector, (AionServerPacket)new SM_SKILL_ACTIVATION(getSkillId(), true));
  }
  ...
  private void deactivateToggleSkill() {
    PacketSendUtility.sendPacket((Player)this.effector, (AionServerPacket)new SM_SKILL_ACTIVATION(getSkillId(), false));
  }
