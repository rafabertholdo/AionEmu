...
/*    */ public class AlwaysBlockEffect
...
/* 55 */     AttackStatusObserver attackStatusObserver = new AttackStatusObserver(this.value, AttackStatus.BLOCK)
/*    */       {
/*    */ 
/*    */         
/*    */         public boolean checkStatus(AttackStatus status)
/*    */         {
/* 61 */           if (status == AttackStatus.BLOCK && this.value > 0) {
/*    */             
/* 63 */             this.value--;
/* 64 */             return true;
/*    */           } 
...
/* 78 */     if (acObserver != null)
/* 79 */       effect.getEffected().getObserveController().removeAttackCalcObserver(acObserver); 
/*    */   }
/*    */ }


/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\com\aionemu\gameserver\skillengine\effect\AlwaysBlockEffect.class
