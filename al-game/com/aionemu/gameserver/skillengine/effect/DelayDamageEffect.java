...
/* 44 */     calculate(effect, DamageType.MAGICAL);
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public void applyEffect(final Effect effect) {
/* 50 */     ThreadPoolManager.getInstance().schedule(new Runnable()
/*    */         {
/*    */           public void run()
/*    */           {
/* 54 */             effect.getEffected().getController().onAttack(effect.getEffector(), effect.getSkillId(), SM_ATTACK_STATUS.TYPE.REGULAR, effect.getReserved1());
/*    */           }
/*    */         }this.delay);
/*    */   }
/*    */ }
