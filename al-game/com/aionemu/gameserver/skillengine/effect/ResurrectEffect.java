...
/* 39 */     PacketSendUtility.sendPacket((Player)effect.getEffected(), (AionServerPacket)new SM_RESURRECT(effect.getEffector(), effect.getSkillId()));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public void calculate(Effect effect) {
/* 45 */     if (effect.getEffected() instanceof Player && effect.getEffected().getLifeStats().isAlreadyDead())
