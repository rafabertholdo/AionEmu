...
/* 148 */     if (this.effects == null) {
/* 149 */       this.effects = new ArrayList<EffectTemplate>();
/*     */     }
/* 151 */     return this.effects;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 168 */     int duration = 0;
/* 169 */     for (EffectTemplate template : getEffects())
/*     */     {
/* 171 */       duration = (duration > template.getDuration()) ? duration : template.getDuration();
/*     */     }
/* 173 */     return duration;
/*     */   }
/*     */ 
...
/* 183 */     for (EffectTemplate template : getEffects()) {
/*     */       
/* 185 */       if (template instanceof ResurrectEffect)
/* 186 */         return true; 
/*     */     } 
/* 188 */     return false;
/*     */   }
...
/* 197 */     for (EffectTemplate template : getEffects()) {
/*     */       
/* 199 */       if (template instanceof ItemHealFpEffect)
/* 200 */         return true; 
/*     */     } 
/* 202 */     return false;
/*     */   }
