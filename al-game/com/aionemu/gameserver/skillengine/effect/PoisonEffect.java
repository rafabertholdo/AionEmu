...
/* 57 */     if (calculateEffectResistRate(effect, StatEnum.POISON_RESISTANCE)) {
...
/* 65 */     effected.getEffectController().unsetAbnormal(EffectId.POISON.getEffectId());
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/*    */     
/* 83 */     effected.getEffectController().setAbnormal(EffectId.POISON.getEffectId());
/*    */     
...
/*    */           public void run()
/*    */           {
/* 90 */             PoisonEffect.this.onPeriodicAction(effect);
/*    */           }
...
/* Location:              D:\games\aion\servers\AionLightning1.9\docker-gs\gameserver\al-game-1.0.1.jar!\com\aionemu\gameserver\skillengine\effect\PoisonEffect.class
