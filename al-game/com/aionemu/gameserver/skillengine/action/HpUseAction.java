...
/* 44 */     Creature effector = skill.getEffector();
/* 45 */     int valueWithDelta = this.value + this.delta * skill.getSkillLevel();
/*    */     
/* 47 */     effector.getLifeStats().reduceHp(valueWithDelta, null);
/*    */   }
/*    */ }
