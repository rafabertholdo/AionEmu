  ...
  public static void remodelItem(Player player, int keepItemObjId, int extractItemObjId) {
    ...
    if (extractItem.getItemTemplate().getTemplateId() == 168100000) {
      ...
      if (!ItemService.decreaseKinah(player, remodelCost)) {
        ...
        PacketSendUtility.sendPacket(player, (AionServerPacket)SM_SYSTEM_MESSAGE.STR_CHANGE_ITEM_SKIN_NOT_ENOUGH_GOLD(new DescriptionId(keepItem.getItemTemplate().getNameId())));
      ...
      PacketSendUtility.sendPacket(player, (AionServerPacket)SM_SYSTEM_MESSAGE.STR_CHANGE_ITEM_SKIN_SUCCEED(new DescriptionId(keepItem.getItemTemplate().getNameId())));
    ...
    if (keepItem.getItemTemplate().getWeaponType() != extractItem.getItemSkinTemplate().getWeaponType() || (extractItem.getItemSkinTemplate().getArmorType() != ArmorType.CLOTHES && keepItem.getItemTemplate().getArmorType() != extractItem.getItemSkinTemplate().getArmorType()) || keepItem.getItemTemplate().getArmorType() == ArmorType.CLOTHES || keepItem.getItemTemplate().getItemSlot() != extractItem.getItemSkinTemplate().getItemSlot()) {
      ...
      PacketSendUtility.sendPacket(player, (AionServerPacket)SM_SYSTEM_MESSAGE.STR_CHANGE_ITEM_SKIN_NOT_COMPATIBLE(new DescriptionId(keepItem.getItemTemplate().getNameId()), new DescriptionId(extractItem.getItemSkinTemplate().getNameId())));
    ...
    if (keepItem.getItemTemplate().getItemQuality() == ItemQuality.EPIC || keepItem.getItemTemplate().getItemQuality() == ItemQuality.MYTHIC) {
      ...
      PacketSendUtility.sendPacket(player, (AionServerPacket)new SM_SYSTEM_MESSAGE(1300478, new Object[] { new DescriptionId(keepItem.getItemTemplate().getNameId()) }));
    ...
    if (extractItem.getItemTemplate().getItemQuality() == ItemQuality.EPIC || extractItem.getItemTemplate().getItemQuality() == ItemQuality.MYTHIC) {
      ...
      PacketSendUtility.sendPacket(player, (AionServerPacket)new SM_SYSTEM_MESSAGE(1300482, new Object[] { new DescriptionId(extractItem.getItemTemplate().getNameId()) }));
    ...
    PacketSendUtility.sendPacket(player, (AionServerPacket)new SM_SYSTEM_MESSAGE(1300483, new Object[] { new DescriptionId(keepItem.getItemTemplate().getNameId()) }));
  }
}
