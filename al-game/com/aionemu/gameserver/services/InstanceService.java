...
public class InstanceService {
  ...
  private static void destroyInstance(WorldMapInstance instance) {
    ...
    for (VisibleObject obj : instance.getAllWorldMapObjects()) {
      ...
      if (obj instanceof Player) {
        ...
        PortalTemplate portal = DataManager.PORTAL_DATA.getInstancePortalTemplate(worldId,
  ...
  public static void onPlayerLogin(Player player) {
    ...
    if (worldTemplate.isInstance()) {
      ...
      if (registeredInstance != null) {
        ...
        World.getInstance().setPosition((VisibleObject) player, worldId, registeredInstance.getInstanceId(),
  ...
  private static void moveToEntryPoint(Player player, PortalTemplate portalTemplate, boolean useTeleport) {
    ...
    if (useTeleport) {
      ...
      World.getInstance().setPosition((VisibleObject) player, entryPoint.getMapId(), 1, entryPoint.getX(),
          entryPoint.getY(), entryPoint.getZ(), player.getHeading());
    }
  }
