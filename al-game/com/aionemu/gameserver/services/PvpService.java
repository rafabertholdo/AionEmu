...
public class PvpService
{
  ...
  public void doReward(Player victim) {
    ...
    PacketSendUtility.broadcastPacketAndReceive((VisibleObject)victim, (AionServerPacket)SM_SYSTEM_MESSAGE.STR_MSG_COMBAT_FRIENDLY_DEATH_TO_B(victim.getName(), winner.getName()));
