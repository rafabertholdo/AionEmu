...
public class GameServer {
  ...
  public GameServer() throws Log4jInitializationError {
    ...
    ServerCfg aion = new ServerCfg(NetworkConfig.GAME_BIND_ADDRESS, NetworkConfig.GAME_PORT, "Game Connections",
        (ConnectionFactory) new GameConnectionFactoryImpl());
    NioServer nioServer = new NioServer(1, (DisconnectionThreadPool) ThreadPoolManager.getInstance(),
        new ServerCfg[] { aion });
