...
public class VersionningService
{
  ...
  public static String[] getFullVersionInfo() {
    return new String[] { "Commons Version: " + getCommonsVersion(), "Commons Revision: " + getCommonsRevision(), "Commons Build Date: " + getCommonsDate(), "GS Version: " + getGameVersion(), "GS Revision: " + getGameRevision(), "GS Build Date: " + getGameDate() };
  }
