...
public class AionPacketHandlerFactory {
  ...
  private AionPacketHandlerFactory() {
    ...
    addPacket((AionClientPacket)new CM_CLIENT_COMMAND_LOC(1), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_RESTORE_CHARACTER(4), new AionConnection.State[] { AionConnection.State.AUTHED });
    ...
    addPacket((AionClientPacket)new CM_L2AUTH_LOGIN_CHECK(8), new AionConnection.State[] { AionConnection.State.CONNECTED });
    addPacket((AionClientPacket)new CM_CHARACTER_LIST(9), new AionConnection.State[] { AionConnection.State.AUTHED });
    addPacket((AionClientPacket)new CM_CREATE_CHARACTER(10), new AionConnection.State[] { AionConnection.State.AUTHED });
    addPacket((AionClientPacket)new CM_DELETE_CHARACTER(11), new AionConnection.State[] { AionConnection.State.AUTHED });
    addPacket((AionClientPacket)new CM_LEGION_UPLOAD_EMBLEM(12), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_LEGION_UPLOAD_INFO(19), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_FRIEND_STATUS(21), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CHANGE_CHANNEL(23), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_SHOW_BLOCKLIST(27), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_BLOCK_SET_REASON(30), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_DISTRIBUTION_SETTINGS(36), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_MAY_LOGIN_INTO_GAME(37), new AionConnection.State[] { AionConnection.State.AUTHED });
    ...
    addPacket((AionClientPacket)new CM_MAC_ADDRESS(48), new AionConnection.State[] { AionConnection.State.CONNECTED, AionConnection.State.AUTHED, AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_REPORT_PLAYER(50), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_GROUP_RESPONSE(51), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_SUMMON_MOVE(52), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_SUMMON_EMOTION(53), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_GODSTONE_SOCKET(70), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_INVITE_TO_GROUP(76), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_ALLIANCE_GROUP_CHANGE(77), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_VIEW_PLAYER_DETAILS(79), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_PLAYER_STATUS_INFO(83), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CLIENT_COMMAND_ROLL(86), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_GROUP_DISTRIBUTION(87), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_SHOW_FRIENDLIST(97), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_SUMMON_COMMAND(100), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BROKER_LIST(102), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_PRIVATE_STORE(106), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_PRIVATE_STORE_NAME(107), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BROKER_SETTLE_LIST(108), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BROKER_SETTLE_ACCOUNT(109), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_SEND_MAIL(111), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BROKER_REGISTERED(112), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BUY_BROKER_ITEM(113), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_REGISTER_BROKER_ITEM(114), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BROKER_CANCEL_REGISTERED(115), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_GET_MAIL_ATTACHMENT(123), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_TELEPORT_SELECT(127), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_PETITION(133), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CHAT_MESSAGE_PUBLIC(134), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CHAT_MESSAGE_WHISPER(135), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_OPEN_STATICDOOR(138), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CASTSPELL(140), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_SKILL_DEACTIVATE(141), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_REMOVE_ALTERED_STATE(142), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_TARGET_SELECT(146), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_PING(151), new AionConnection.State[] { AionConnection.State.AUTHED, AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_FLIGHT_TELEPORT(156), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_QUESTION_RESPONSE(157), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_LEGION_MODIFY_EMBLEM(166), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CLOSE_DIALOG(168), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_DIALOG_SELECT(169), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_LEGION_TABS(170), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_EXCHANGE_ADD_KINAH(173), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_EXCHANGE_LOCK(174), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_EXCHANGE_OK(175), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_EXCHANGE_REQUEST(178), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_EXCHANGE_ADD_ITEM(179), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_MANASTONE(181), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_EXCHANGE_CANCEL(184), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_PLAY_MOVIE_END(188), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_SUMMON_CASTSPELL(192), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_FUSION_WEAPONS(193), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_BREAK_WEAPONS(194), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_LEGION_SEND_EMBLEM(211), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_DISCONNECT(237), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_QUIT(238), new AionConnection.State[] { AionConnection.State.AUTHED, AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_MAY_QUIT(239), new AionConnection.State[] { AionConnection.State.AUTHED, AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_VERSION_CHECK(243), new AionConnection.State[] { AionConnection.State.CONNECTED });
    ...
    addPacket((AionClientPacket)new CM_OBJECT_SEARCH(246), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_CUSTOM_SETTINGS(247), new AionConnection.State[] { AionConnection.State.IN_GAME });
    ...
    addPacket((AionClientPacket)new CM_TIME_CHECK(253), new AionConnection.State[] { AionConnection.State.CONNECTED, AionConnection.State.AUTHED, AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_GATHER(254), new AionConnection.State[] { AionConnection.State.IN_GAME });
    addPacket((AionClientPacket)new CM_QUESTIONNAIRE(124), new AionConnection.State[] { AionConnection.State.IN_GAME });
  }
