  ...
  extends AionClientPacket
{
  ...
  protected void runImpl() {
    ...
    sendPacket((AionServerPacket)new SM_LEGION_SEND_EMBLEM(this.legionId, legionEmblem.getEmblemId(), legionEmblem.getColor_r(), legionEmblem.getColor_g(), legionEmblem.getColor_b(), legion.getLegionName()));
  }
}
