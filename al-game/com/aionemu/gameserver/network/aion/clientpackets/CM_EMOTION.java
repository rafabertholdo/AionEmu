...
public class CM_EMOTION extends AionClientPacket {
  ...
  protected void runImpl() {
    ...
    PacketSendUtility.broadcastPacket(player, (AionServerPacket) new SM_EMOTION(player, this.emotionType, this.emotion,
        this.x, this.y, this.z, this.heading, (player.getTarget() == null) ? 0 : player.getTarget().getObjectId()),
        true);
  }
}
