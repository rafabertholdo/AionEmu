...
public class CM_USE_ITEM extends AionClientPacket {
  ...
  protected void runImpl() {
    ...
    if (item == null) {
      ...
      log.warn(String.format("CHECKPOINT: null item use action: %d %d",
          new Object[] { Integer.valueOf(player.getObjectId()), Integer.valueOf(this.uniqueItemId) }));
    ...
    if (QuestEngine.getInstance().onItemUseEvent(new QuestEnv(null, player, Integer.valueOf(0), Integer.valueOf(0)),
        item)) {
      return;
    }
