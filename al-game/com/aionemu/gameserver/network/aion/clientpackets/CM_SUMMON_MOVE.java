  ...
  protected void runImpl() {
    ...
    switch (this.type) {
      ...
      case MOVEMENT_START_KEYBOARD:
        ...
        PacketSendUtility.broadcastPacket((VisibleObject)summon, (AionServerPacket)new SM_MOVE(summon.getObjectId(), this.x, this.y, this.z, this.x2, this.y2, this.z2, this.heading, this.type));
        break;
      case VALIDATE_MOUSE:
      case VALIDATE_KEYBOARD:
        PacketSendUtility.broadcastPacket((VisibleObject)summon, (AionServerPacket)new SM_MOVE(summon.getObjectId(), this.x, this.y, this.z, this.x2, this.y2, this.z2, this.heading, (this.type == MovementType.VALIDATE_MOUSE) ? MovementType.MOVEMENT_START_MOUSE : MovementType.MOVEMENT_START_KEYBOARD));
        break;

      
      case MOVEMENT_STOP:
        PacketSendUtility.broadcastPacket((VisibleObject)summon, (AionServerPacket)new SM_MOVE(summon.getObjectId(), this.x, this.y, this.z, this.heading, this.type));
        World.getInstance().updatePosition((VisibleObject)summon, this.x, this.y, this.z, this.heading);
        break;
      case UNKNOWN:
