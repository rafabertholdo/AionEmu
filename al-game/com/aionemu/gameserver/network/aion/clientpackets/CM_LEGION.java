  ...
  protected void runImpl() {
    ...
    if (activePlayer.isLegionMember()) {
      ...
      if (this.charName != null) {
        LegionService.getInstance().handleCharNameRequest(this.exOpcode, activePlayer, this.charName, this.newNickname,
            this.rank);
      } else {
        switch (this.exOpcode) {
          ...
          case 13:
            if (activePlayer.getLegionMember().isBrigadeGeneral()) {
              LegionService.getInstance().changePermissions(legion, this.legionarPermission2, this.centurionPermission1,
                  this.centurionPermission2);
            }
            return;
        }
