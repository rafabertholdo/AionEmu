    ...
    if (!this.targetName.equalsIgnoreCase(activePlayer.getName())) {
      ...
      if (targetPlayer == null) {
        ...
        RequestResponseHandler responseHandler = new RequestResponseHandler((Creature) activePlayer) {
          ...
          public void acceptRequest(Creature requester, Player responder) {
            if (!targetPlayer.getCommonData().isOnline()) {
              ...
              CM_FRIEND_ADD.this
                  .sendPacket((AionServerPacket) new SM_FRIEND_RESPONSE(CM_FRIEND_ADD.this.targetName, 1));
            } else {
        ...
        if (!requested) {
          ...
          targetPlayer.getClientConnection().sendPacket((AionServerPacket) new SM_QUESTION_WINDOW(900841,
              activePlayer.getObjectId(), new Object[] { activePlayer.getName() }));
        }
      }
    }
  }
