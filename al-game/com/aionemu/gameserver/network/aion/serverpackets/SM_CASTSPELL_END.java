...
public class SM_CASTSPELL_END extends AionServerPacket {
  ...
  public SM_CASTSPELL_END(Creature attacker, Creature target, List<Effect> effects, int spellid, int level,
      int cooldown, boolean chainSuccess, int spellStatus) {
  ...
  public SM_CASTSPELL_END(Creature attacker, Creature target, List<Effect> effects, int spellid, int level,
      int cooldown, boolean chainSuccess, int spellStatus, float x, float y, float z) {
