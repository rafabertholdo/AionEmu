...
public abstract class CreatureController<T extends Creature> extends VisibleObjectController<Creature> {
  ...
  public void notSee(VisibleObject object, boolean isOutOfRange) {
    ...
    if (object == getOwner().getTarget()) {
      ...
      PacketSendUtility.broadcastPacket((VisibleObject) getOwner(),
          (AionServerPacket) new SM_LOOKATOBJECT((VisibleObject) getOwner()));
    }
  ...
  public void stopMoving() {
    ...
    World.getInstance().updatePosition((VisibleObject) owner, owner.getX(), owner.getY(), owner.getZ(),
        owner.getHeading());
    PacketSendUtility.broadcastPacket((VisibleObject) owner, (AionServerPacket) new SM_MOVE(owner.getObjectId(),
        owner.getX(), owner.getY(), owner.getZ(), owner.getHeading(), MovementType.MOVEMENT_STOP));
  }
  ...
  public void cancelCurrentSkill() {
    ...
    if (castingSkill != null) {
      ...
      creature.setCasting(null);
      PacketSendUtility.broadcastPacketAndReceive((VisibleObject) creature,
          (AionServerPacket) new SM_SKILL_CANCEL(creature, castingSkill.getSkillTemplate().getSkillId()));
    }
  }
