...
public enum MovementType {
  ...
  MOVEMENT_STAYIN_ELEVATOR(24), MOVEMENT_JUMPIN_ELEVATOR(-48), MOVEMENT_VALIDATEIN_ELEVATOR(-112),
  MOVEMENT_MOVIN_ELEVATOR(-16), MOVEMENT_ON_ELEVATOR(16), MOVEMENT_GO_UPDOWN_ELEVATOR(-80),
