...
public final class RestrictionsManager
{
    ...
    implements Comparator<Restrictions>
  {
    ...
    private boolean equalsMethod(Method method) { if (!this.METHOD.getName().equals(method.getName()))
        ...
        return false; 
      return Arrays.equals((Object[])this.METHOD.getParameterTypes(), (Object[])method.getParameterTypes()); } private static RestrictionMode parse(Method method) { for (RestrictionMode mode : VALUES) {
    ...
    private double getPriority(Restrictions restriction) {
      RestrictionPriority a1 = getMatchingMethod((Class)restriction.getClass()).<RestrictionPriority>getAnnotation(RestrictionPriority.class);
      if (a1 != null) {
        return a1.value();
      }
