...
public class QuestHandler {
  ...
  public synchronized void updateQuestStatus(Player player, QuestState qs) {
    PacketSendUtility.sendPacket(player, (AionServerPacket) new SM_QUEST_ACCEPTED(this.questId.intValue(),
  ...
  public boolean sendQuestDialog(Player player, int objId, int dialogId) {
    PacketSendUtility.sendPacket(player,
        (AionServerPacket) new SM_DIALOG_WINDOW(objId, dialogId, this.questId.intValue()));
    return true;
  }
