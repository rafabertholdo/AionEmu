...
public class Petition {
  ...
  public Petition(int petitionId, int playerObjId, int petitionTypeId, String title, String contentText,
    ...
    switch (petitionTypeId) {
      case 256:
        this.type = PetitionType.CHARACTER_STUCK;
        break;
      case 512:
        this.type = PetitionType.CHARACTER_RESTORATION;
        break;
      case 768:
        this.type = PetitionType.BUG;
        break;
      case 1024:
        this.type = PetitionType.QUEST;
        break;
      case 1280:
        this.type = PetitionType.UNACCEPTABLE_BEHAVIOR;
        break;
      case 1536:
        this.type = PetitionType.SUGGESTION;
        break;
      case 65280:
        this.type = PetitionType.INQUIRY;
        break;
    ...
    switch (petitionStatus) {
      case 0:
        ...
        return;
      case 1:
        this.status = PetitionStatus.IN_PROGRESS;
        return;
      case 2:
        this.status = PetitionStatus.REPLIED;
        return;
    }
    this.status = PetitionStatus.PENDING;
  }
