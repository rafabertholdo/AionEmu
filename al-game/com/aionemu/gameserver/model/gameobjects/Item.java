  ...
  extends AionObject
{
  ...
  public String toString() {
    return "Item [equipmentSlot=" + this.equipmentSlot + ", godStone=" + this.godStone + ", isEquipped=" + this.isEquipped + ", itemColor=" + this.itemColor + ", itemCount=" + this.itemCount + ", itemLocation=" + this.itemLocation + ", itemTemplate=" + this.itemTemplate + ", manaStones=" + this.manaStones + ", persistentState=" + this.persistentState + "]";
  }
  ...
  public void finalize() {
    if (this.persistentState == PersistentState.NOACTION || this.persistentState == PersistentState.DELETED || this.ownerId == 0)
    {
