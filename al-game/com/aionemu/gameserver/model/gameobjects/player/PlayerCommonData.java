  ...
  extends VisibleObjectTemplate
{
  ...
  public void calculateExpLoss() {
    ...
    if (getPlayer() != null) {
      PacketSendUtility.sendPacket(getPlayer(), (AionServerPacket)new SM_STATUPDATE_EXP(getExpShown(), getExpRecoverable(), getExpNeed()));
    }
  }
  ...
  public void addAp(int value) {
    ...
    PacketSendUtility.sendPacket(player, (AionServerPacket)SM_SYSTEM_MESSAGE.EARNED_ABYSS_POINT(String.valueOf(value)));
    ...
    if (player.isLegionMember() && value > 0) {
      ...
      PacketSendUtility.broadcastPacketToLegion(player.getLegion(), (AionServerPacket)new SM_LEGION_EDIT(3, player.getLegion()));
    } 
  }
  ...
  public void setDp(int dp) {
    if (getPlayer() != null) {
      ...
      PacketSendUtility.broadcastPacket(getPlayer(), (AionServerPacket)new SM_DP_INFO(this.playerObjId, this.dp), true);
