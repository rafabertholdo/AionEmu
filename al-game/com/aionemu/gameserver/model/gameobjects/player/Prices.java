...
public class Prices
{
  ...
  public int getVendorSellModifier() {
    return (int)(((int)(((int)((PricesConfig.VENDOR_SELL_MODIFIER * getGlobalPrices()) / 100.0F) * getGlobalPricesModifier()) / 100.0F) * getTaxes()) / 100.0F);
  }
  ...
  public long getPriceForService(long basePrice) {
    return (long)(((long)(((long)((basePrice * getGlobalPrices()) / 100.0D) * getGlobalPricesModifier()) / 100.0D) * getTaxes()) / 100.0D);
  }
  ...
  public long getKinahForBuy(long requiredKinah) {
    return (long)(((long)(((long)(((long)((requiredKinah * getVendorBuyModifier()) / 100.0D) * getGlobalPrices()) / 100.0D) * getGlobalPricesModifier()) / 100.0D) * getTaxes()) / 100.0D);
  }
