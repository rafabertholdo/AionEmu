  ...
  extends Creature
{
  ...
  public Player(PlayerController controller, PlayerCommonData plCommonData, PlayerAppearance appereance) {
    super(plCommonData.getPlayerObjId(), (CreatureController)controller, null, plCommonData, plCommonData.getPosition());
  ...
  public void onLoggedIn() {
    getController().addTask(TaskId.PLAYER_UPDATE, ThreadPoolManager.getInstance().scheduleAtFixedRate(new GeneralUpdateTask(this), (OptionsConfig.PLAYER_GENERAL * 1000), (OptionsConfig.PLAYER_GENERAL * 1000)));
  }
    ...
    implements Runnable
  {
    ...
    public void run() {
      try {
        ...
        Player.log.error(("Exception during periodic saving of player " + this.player.getName() + " " + ex.getCause() != null) ? ex.getCause().getMessage() : "null");
      } 
    }
  }
