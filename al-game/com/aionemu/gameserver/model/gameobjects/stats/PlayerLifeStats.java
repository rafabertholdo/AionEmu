  ...
  extends CreatureLifeStats<Player>
{
  ...
  public PlayerLifeStats(Player owner) {
    super((Creature)owner, owner.getGameStats().getCurrentStat(StatEnum.MAXHP), owner.getGameStats().getCurrentStat(StatEnum.MAXMP));
  ...
  public void sendHpPacketUpdateImpl() {
    ...
    PacketSendUtility.sendPacket((Player)this.owner, (AionServerPacket)new SM_STATUPDATE_HP(this.currentHp, getMaxHp()));
  }
  ...
  public void sendMpPacketUpdateImpl() {
    ...
    PacketSendUtility.sendPacket((Player)this.owner, (AionServerPacket)new SM_STATUPDATE_MP(this.currentMp, getMaxMp()));
  }
  ...
  public void triggerFpReduce() {
    ...
    if (this.flyReduceTask == null && !this.alreadyDead && getOwner().getAccessLevel() < AdminConfig.GM_FLIGHT_UNLIMITED)
    {
  ...
  protected void sendAttackStatusPacketUpdate(SM_ATTACK_STATUS.TYPE type, int value) {
    ...
    PacketSendUtility.sendPacket((Player)this.owner, (AionServerPacket)new SM_ATTACK_STATUS(this.owner, type, 0, value));
    PacketSendUtility.broadcastPacket((VisibleObject)this.owner, (AionServerPacket)new SM_ATTACK_STATUS(this.owner, 0));
  }
}
