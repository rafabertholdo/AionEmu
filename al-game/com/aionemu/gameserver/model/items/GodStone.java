    ...
    this.actionListener = new ActionObserver(ActionObserver.ObserverType.ATTACK) {
      public void attack(Creature creature) {
        ...
        if (rand > Rnd.get(0, 1000)) {
          ...
          Skill skill = SkillEngine.getInstance().getSkill((Creature) player, GodStone.this.godstoneInfo.getSkillid(),
              GodStone.this.godstoneInfo.getSkilllvl(), player.getTarget());
