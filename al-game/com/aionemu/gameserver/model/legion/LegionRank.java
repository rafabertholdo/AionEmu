...
public enum LegionRank
{
  ...
  public boolean canUseGateGuardianStone(int centurionPermission2, int legionarPermission2) {
    switch (this) {
      ...
      case CENTURION:
        if (centurionPermission2 == 8 || centurionPermission2 == 10 || centurionPermission2 == 12 || centurionPermission2 == 14)
        {
  ...
  public boolean canUseArtifact(int centurionPermission2) {
    switch (this) {
      ...
      case CENTURION:
        if (centurionPermission2 == 4 || centurionPermission2 == 6 || centurionPermission2 == 12 || centurionPermission2 == 14)
        {
  ...
  public boolean canEditAnnouncement(int centurionPermission2) {
    switch (this) {
      ...
      case CENTURION:
        if (centurionPermission2 == 2 || centurionPermission2 == 10 || centurionPermission2 == 12 || centurionPermission2 == 14)
        {
  ...
  public boolean canUseLegionWarehouse(int centurionPermission1) {
    switch (this) {
      ...
      case CENTURION:
        if (centurionPermission1 == 4 || centurionPermission1 == 20 || centurionPermission1 == 20 || centurionPermission1 == 28)
        {
  ...
  public boolean canKickFromLegion(int centurionPermission1) {
    switch (this) {
      ...
      case CENTURION:
        if (centurionPermission1 == 16 || centurionPermission1 == 12 || centurionPermission1 == 24 || centurionPermission1 == 28)
        {
  ...
  public boolean canInviteToLegion(int centurionPermission1) {
    switch (this) {
      ...
      case CENTURION:
        if (centurionPermission1 == 8 || centurionPermission1 == 20 || centurionPermission1 == 24 || centurionPermission1 == 28)
        {
