...
public class RecipeData
{
  ...
  public RecipeTemplate[] getRecipeIdFor(Race race, int skillId, int skillPoint) {
    ...
    List<RecipeTemplate> raceSpecificTemplates = (List<RecipeTemplate>)this.learnTemplates.get(makeHash(race.ordinal(), skillId, skillPoint));
    
    List<RecipeTemplate> allRaceSpecificTemplates = (List<RecipeTemplate>)this.learnTemplates.get(makeHash(SkillRace.ALL.ordinal(), skillId, skillPoint));
