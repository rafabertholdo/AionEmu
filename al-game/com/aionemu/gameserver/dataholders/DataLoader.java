...
abstract class DataLoader
{
  ...
  protected void loadData() {
    if (this.dataFile.isDirectory()) {
      ...
      Collection<?> files = FileUtils.listFiles(this.dataFile, FileFilterUtils.andFileFilter(FileFilterUtils.andFileFilter(FileFilterUtils.notFileFilter(FileFilterUtils.nameFileFilter("new")), FileFilterUtils.suffixFileFilter(".txt")), HiddenFileFilter.VISIBLE), HiddenFileFilter.VISIBLE);
