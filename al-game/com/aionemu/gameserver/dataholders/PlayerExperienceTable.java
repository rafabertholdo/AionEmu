...
/* 48 */     if (level > this.experience.length) {
/* 49 */       throw new IllegalArgumentException("The given level is higher than possible max");
/*    */     }
/* 51 */     return (level > this.experience.length) ? 0L : this.experience[level - 1];
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 61 */     return (this.experience == null) ? 0 : this.experience.length;
/*    */   }
/*    */ }
