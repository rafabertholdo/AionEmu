...
public class World
{
  ...
  public void updatePosition(VisibleObject object, float newX, float newY, float newZ, byte newHeading, boolean updateKnownList) {
    ...
    if (oldRegion == null) {
      ...
      log.warn(String.format("CHECKPOINT: oldregion is null, object coordinates - %d %d %d", new Object[] { Float.valueOf(object.getX()), Float.valueOf(object.getY()), Float.valueOf(object.getY()) }));
