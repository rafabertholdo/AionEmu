...
public abstract class AI<T extends Creature> implements Runnable {
  ...
  public void run() {
    this.desireQueue.iterateDesires((DesireIteratorHandler) new GeneralDesireIteratorHandler(this),
        new DesireIteratorFilter[] { (DesireIteratorFilter) new CounterBasedDesireFilter() });
