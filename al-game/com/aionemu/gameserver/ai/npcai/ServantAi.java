  ...
  extends NpcAi
{
    ...
    extends StateHandler
  {
    ...
    public void handleState(AIState state, AI<?> ai) {
      ...
      {
        ai.addDesire((Desire)new ServantAi.ServantSkillUseDesire(owner, (Creature)servantOwnerTarget, AIState.ACTIVE.getPriority()));
      }
    ...
    extends AbstractDesire
  {
    ...
    public boolean handleDesire(AI<?> ai) {
      ...
      Skill skill = SkillEngine.getInstance().getSkill((Creature)this.owner, this.owner.getSkillId(), 1, (VisibleObject)this.target);
      if (skill != null) {
