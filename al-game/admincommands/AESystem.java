...
public class AESystem extends AdminCommand {
  ...
  public void executeCommand(Player admin, String[] params) {
    ...
    if (params[0].equals("info")) {
      ...
      System.gc();
      PacketSendUtility.sendMessage(admin,
          "RAM Used (After): " + ((Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576L));

      System.runFinalization();
      PacketSendUtility.sendMessage(admin,
          "RAM Used (Final): " + ((Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576L));
