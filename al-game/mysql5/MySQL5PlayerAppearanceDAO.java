...
public class MySQL5PlayerAppearanceDAO extends PlayerAppearanceDAO {
    ...
    public PlayerAppearance load(int playerId) {
        ...
        try {
            ...
            log.fatal("Could not restore PlayerAppearance data for player " + playerId + " from DB: " + e.getMessage(),
                    e);
            return null;
        } finally {
 ...
 * !\mysql5\MySQL5PlayerAppearanceDAO.class Java compiler version: 6 (50.0)
