    ...
    public void run() {
      ...
      if (sizeNow < this.lastSize) {
        ...
        if (!PacketProcessor.this.newThread() && sizeNow >= 150) {
          PacketProcessor.log.info("Lagg detected! [" + sizeNow + " client packets are waiting for execution]. You should consider increasing PacketProcessor maxThreads or hardware upgrade.");
        }
      } 
